...
| 项目 | 链接 | 说明 |
|------|------|------|
| GitHub仓库 | [https://github.com/ckhongdadada/-Qt_coursework](https://github.com/ckhongdadada/-Qt_coursework) | 源代码托管 |
| 文档地址 | [https://github.com/ckhongdadada/-Qt_coursework](https://github.com/ckhongdadada/-Qt_coursework) | 项目文档 |
| Issue追踪 | [https://github.com/ckhongdadada/-Qt_coursework/issues](https://github.com/ckhongdadada/-Qt_coursework/issues) | Bug和功能请求 |
...
| 成员 | 职责 | 工作量占比 |
|------|------|-----------|
| **组长** | 架构设计、核心协调器、MainWindow、Qt UI页面与交互、进度管理 | 30% |
...
| UI开发 | 第7-8周 | Qt页面、组件、对话框与交互 | 组长 | ✅ 完成 |
...
4. **CORS中间件**：作为本地HTTP接口的兼容扩展，便于调试、联调和后续Web端访问
